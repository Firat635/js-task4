...
// function olke(id) {
//   let olkeID =  netice.find(item =>item.id ==id);
//     console.log(olkeID)
// }
// olke(11072)
...
// function olketapmaq(olke){
//     let olketap=netice.filter( item => item.shipAddress.country === olke)
//     console.log(olketap);
// }
// olketapmaq("USA")
...
// function idname(id){
//     let idtap = netice.find(item => item.id === id);

//    let shipname= idtap.shipName;
//     let country= idtap.shipAddress.country;
//   let city=  idtap.shipAddress.city;
